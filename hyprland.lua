...
hl.bind(mainMod .. " + M", hl.dsp.exec_cmd("systemctl suspend"), { description = "Sleep" })
hl.bind(mainMod .. " + CTRL + M", hl.dsp.exec_cmd("/usr/bin/hyprshutdown"), { description = "Exit Hyprland" })
...
hl.bind("switch:Lid Switch", hl.dsp.exec_cmd("hyprlock"), { description = "Lock on lid close", locked = true })
hl.bind("XF86MonBrightnessUp", hl.dsp.exec_cmd("brightnessctl s 5%+"), { description = "Brightness up", locked = true, repeating = true })
hl.bind("XF86MonBrightnessDown", hl.dsp.exec_cmd("brightnessctl s 5%-"), { description = "Brightness down", locked = true, repeating = true })
